...
const CategoryIcon = ({ category, type }: {category: Category, type:  "static" | "select_icon"}) => {
    ...
    if (type === "select_icon") {
        return (
            <button onClick={handleOpenModal} type='button' className={styles["category-icon-button"]}>
