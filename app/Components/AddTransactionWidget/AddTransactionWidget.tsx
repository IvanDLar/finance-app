...
const AVAILABLE_CATEGORIES: Categories[] = ["Pets",
    "Dinning",
    "Groceries",
    "Shopping",
    "Transit",
        ...
        <Modal
            ...
            >
                {AVAILABLE_CATEGORIES.map((category: Categories) => {
                    return (
                        <div key={category} className={css({
                            display: "flex",
...
const AddTransactionWidget = ({ session }: any) => {
    ...
    const [transactionCategory, setTransactionCategory] = useState<Categories>("Bills & Fees");
    ...
    return (
        <div>
            <CategoryModal isCategoryModalOpen={isCategoryModalOpen} setIsCategoryModalOpen={setIsCategoryModalOpen} />
                ...
                <div className={styles["transaction-card__section"]}>
                    <div className={styles["transaction-card__top"]}>
                        <div className={styles["icon__section"]}>
                            <CategoryIcon category={transactionCategory} type="select_icon" setIsModalOpen={setIsCategoryModalOpen} />
                        </div>
