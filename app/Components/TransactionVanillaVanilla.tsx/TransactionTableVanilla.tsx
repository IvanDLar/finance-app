...
const TransactionVanillaTable = ({
  ...
  const handlePagination = () => {
    ...
    if (currPage === availablePages)
      setIsArrowDisabled({ left: false, right: true });
    if (currPage !== 0 && currPage !== availablePages)
  ...
  return (
    <>
            ...
            return (
              <tr key={transaction.id}>
                ...
                <td
                  ...
                  className={styles.delete_transaction}
                >
                  {<Delete />}
                </td>
              </tr>
      ...
      <div className={styles.pages_section}>
        <a
          className={`${styles['change-date-arrows']} ${styles['left-arrow']} ${isArrowDisabled.left && styles.disabled}`}
        ...
        <p>Page: {currPage + 1}</p>
        <a
          className={`${styles['change-date-arrows']} ${styles['right-arrow']} ${isArrowDisabled.right && styles.disabled}`}
