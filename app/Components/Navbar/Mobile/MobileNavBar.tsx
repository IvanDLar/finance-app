  ...
  return (
    <div className={styles['mobile-navbar__container']}>
      <div className={styles['mobile-navbar']}>
        <Link
          href={'/routes/profile'}
          className={styles['mobile-navbar-element']}
        >
        ...
        <div
          className={`${styles['add-transaction-container']} ${styles['mobile-navbar-element']}`}
        >
          <Link
            href={'/routes/add-transaction'}
            className={styles['mobile-navbar-element']}
          >
            <AddIcon
              className={`${styles['mobile-navbar__icon']} ${styles['mobile-navbar__add-icon']}`}
            />
          </Link>
        </div>
        <Link
